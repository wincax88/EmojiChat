...
#define MIN_PEResizeControl_HEIGHT  30.0f
...
{
    self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, MIN_PEResizeControl_HEIGHT, MIN_PEResizeControl_HEIGHT)];
    if (self) {
