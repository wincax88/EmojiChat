...
//-----------------------------------------------------------------------
#define		PF_INVITE_CLASS_NAME				@"Invite"				//	Class name
#define		PF_INVITE_INVITER_PHONE				@"inviterPhone"			//	inviter phone
#define		PF_INVITE_INVITER_NICK				@"inviterNick"			//	inviter phone
#define		PF_INVITE_INVITER_AVATAR            @"inviterAvatar"        //	inviter avatar
#define		PF_INVITE_INVITEE_PHONE				@"inviteePhone"			//	Invite Phone
#define		PF_INVITE_INVITEE_NICK				@"inviteeNick"			//	Invite Nick
#define		PF_INVITE_TIME                      @"inviteTime"			//	Invite time
