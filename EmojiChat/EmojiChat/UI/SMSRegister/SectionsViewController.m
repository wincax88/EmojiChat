...
- (void)viewDidLoad {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 88+statusBarHeight, self.view.frame.size.width, self.view.bounds.size.height-(88+statusBarHeight)) style:UITableViewStylePlain];
...
- (void)resetSearch
{
    NSMutableDictionary *allNamesCopy = [allNames mutableDeepCopy];
    _names = allNamesCopy;
